...
export default function Recorder(){
	return (
		<div className = "container gc-row-1 mt-3">
			<div className = "gc-recorder gc-row-1 p-2">
				<svg className="h-100 w-100" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
